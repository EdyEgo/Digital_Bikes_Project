...
function App() {  
  ...
  //         .collection('motorcyclesCollection').doc('motorcycles').get();

  //         const documents = get_brands_available_doc_array_moto.data();
  //         const brands_available = documents?documents['brands_available'] : null;
          

  //         console.log('data is this sha',documents)
